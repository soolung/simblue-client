...
export default function ApplicationManagement() {
  ...
  return (
    <>
      ...
      <section
        className={`application-management ${noticeIsOpened ? "half" : ""}`}
      >
        <div className="application-management-application-header">
          ...
          <p className="application-management-application-header-description">
        ...
        <ResultTable tableRef={tableRef} data={data} />
      </section>
    </>
  );
}
