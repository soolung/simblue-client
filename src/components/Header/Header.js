                ...
                <div className='header-inner'>
                    <div className='header-logo'>
                        <Link to="/">
                            <ul className='header_logo'>
                                <li><img src='https://ifh.cc/g/cs0mAl.png' alt='logo'/></li>
                                {/*a 태그로 하고 싶은데 외안대*/}
                    ...
                    <div className={
                        ...
                        <ul className='header-category-ul'>
                            <li className='header-nav-li'><Link to="/look"><a>둘러보기</a></Link></li>
                            {user?.authority &&
                                <li className='header-nav-li'><Link to="/record"><a>기록보기</a></Link></li>
                            }
                            {user?.authority === "ROLE_TEACHER" ?
                                <li className='header-nav-li'><Link to="/create"><a>만들기</a></Link></li>
                                :
                                <></>
                            }
                        </ul>
                        ...
                        <div className="search">
                            ...
                            <input type="image" className="search-go" src={"https://ifh.cc/g/nXpwoz.png"}
                                   alt="search-go"/>
                        </div>
